...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-info shadow sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item {{ Nav::isRoute('dasboard') }}">
            <a class="nav-link" href="{{ route('dasboard') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>{{ __('Overview') }}</span></a>
        </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <img src="{{ asset('img/idenFD.png') }}" class="img-profile rounded-circle avatar font-weight-bold">
                            @else
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="{{ route('costumer') }}">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>RentNow &copy; Sewa Barang Elektronik {{ now()->year }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
