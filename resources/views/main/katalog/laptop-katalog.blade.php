...
<h2 class="ml-4 text-center">Laptop Katalog</h2>
            ...
            <div class="row row-cols-3">
              ...
              <a class="nav-link  link-dark" href="{{ url('/detail-katalog/'.$laptop->id.'') }}">
              <div class="col">
                <div class="row m-1">
                    <div class="card">
                      <img src="{{ asset($laptop->imgP) }}" width="400px" class="img-fluid" alt="...">
                      <div class="card-body text-white" style="background-color:#4DD8E8">
                       <center><h5 class="card-title">{{$laptop->nameP}}</h5></center> 
                    </div>
                  </div>
                </div>
              </div>
