...
<h2 class="ml-4 text-center">Laptop Katalog</h2>
</div>
            <hr>
            <div class="container">
            <div class="row">
              ...
              <div class="col-4 mb-3">
                <div class="card" >
                  <img src="{{ asset($laptop->imgP) }}" class="card-img-top" width="400px" alt="...">
                  <div class="card-body text-white" style="background-color:#4DD8E8">
                    <a class="nav-link  link-light" href="{{ url('/detail-katalog/'.$laptop->id.'') }}"> <h5 class="card-title text-center">{{$laptop->nameP}}</h5></a>
                  </div>
            </div>
          </div>
              @endforeach
